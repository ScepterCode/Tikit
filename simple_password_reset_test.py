                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                    <tr>
                        <td style="padding: 40px 40px 20px; text-align: center;">
                            <h1 style="color: #667eea; margin: 0; font-size: 32px;">🔐 Grooovy Password Reset</h1>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 40px 40px;">
                            ...
                            <p style="color: #6b7280; font-size: 16px; line-height: 1.6; margin: 0 0 30px;">
                                Click the button below to reset your Grooovy password:
                            </p>
...
email_data = {
    ...
    'text_body': f'Reset your Grooovy password: {reset_url}\n\nThis link expires in 1 hour.',
...
if response.status_code == 200:
    ...
    if result['summary']['sent'] > 0:
        ...
        print(f"   • Subject: Reset Your Grooovy Password")
        print(f"   • From: Grooovy <onboarding@resend.dev>")
